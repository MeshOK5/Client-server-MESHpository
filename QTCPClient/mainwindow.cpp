...
void MainWindow::discardSocket()
{
    ...
    QMessageBox::critical(this,"QTCPClient","Socket was closed");
...
void MainWindow::on_connect_clicked()
{
    ...
    if(socket->waitForConnected()){
        ui->statusBar->showMessage("Connected to Server with");
        ui->textBrowser_receivedMessages->append(ip.toString());
        ui->textBrowser_receivedMessages->append(QString::number(port));

        ui->connect->setEnabled(false);
        ui->pushButton_sendMessage->setEnabled(true);
        ui->pushButton_sendAttachment->setEnabled(true);
    }
    else{
